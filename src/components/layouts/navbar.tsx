...
export default function Navbar() {
  ...
  return (
    <div className='w-full flex flex-col items-center p-5 sm:flex-row justify-between text-white bg-[#140D27]'>
      ...
      <div
        className={`${
          isMenuOpen
            ...
            : 'hidden opacity-0'
        } transition-opacity ease-in-out duration-300 sm:items-center sm:flex md:hidden lg:hidden`}
      >
